...
public class AuthenticatedFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (uri.contains(".png") || uri.contains(".jpg") || uri.contains(".gif")
                    || uri.contains("manager.js") || uri.contains(".css") || uri.contains("min.js") || uri.contains("https://kit.fontawesome.com/478461b23c.js")) {
                ...
                if (uri.contains("login.jsp") || uri.contains("LoginController")
                        ...
                        || uri.contains("CategoryController")
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AuthenticatedFilter:Initializing filter");
            }
        }
    }
